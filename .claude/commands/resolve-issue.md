...
| 분석 수준 | 문서 포함 내용 | 다음 단계 전략 | 예상 시간 | 토큰 사용 | 서브에이전트 |
| --------- | ------------- | ------------- | --------- | --------- | ------------ |
| **Quick Win** | 작업 내용 (체크리스트) + 완료 기준 | 최소 검증 | ~5분 | ~5k | 1개 |
