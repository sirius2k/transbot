...
- 사용자가 한국어 텍스트를 입력: "안녕하세요, 내일까지 보고서를 제출해주세요."
- "번역하기" 버튼을 클릭

**Then** (예상 결과)

- "자연스러운 구어체" 스타일 번역 결과가 표시됨
- "공식/문서용" 스타일 번역 결과가 표시됨
- 두 스타일이 명확히 구분되어 표시됨
...
| 한국어 텍스트 (다중 스타일) | "안녕하세요, 내일까지 보고서를 제출해주세요." | 다중 스타일 테스트 |
...
| 한국어→영어 | 번역 결과 섹션 표시됨 | 결과 섹션 존재 확인 |
