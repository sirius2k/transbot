...
| 9.2 | .env.example 업데이트 | 🔲 대기 | 30m | - | - | - | [#3](https://github.com/sirius2k/transbot/issues/3) |
| 9.3 | TranslationManager 적용 | 🔲 대기 | 1h | - | - | - | [#4](https://github.com/sirius2k/transbot/issues/4) |
