...
| ✅ Langfuse Prompt 표시 개선    | **P2**   | 30분      | Langfuse Generation에 Prompt 섹션 추가. LLM 호출 시 시스템/사용자 메시지 확인 가능  | -    |
...
| 개선사항                   | 우선순위 | 소요 시간 | 설명                                                                                                                                       | 이슈                                                  |
| -------------------------- | -------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------- |
| 🔲 모델 선택 옵션 제한     | **P1**   | 1-2시간   | 환경 변수에 설정된 모델만 UI에 표시. API 키 미설정 모델 선택 방지. 사용자 혼란 최소화. 에러 사전 차단                                    | -                                                     |
| 🔲 Langfuse 메타데이터 확장 | **P1**   | 1-2시간   | Langfuse Trace/Generation에 설정 메타데이터 추가 (번역 스타일, 추가 옵션, 모델 설정, UI 상태). 프롬프트 비교 분석, 사용 패턴 파악, 디버깅 개선, 품질 모니터링 | -                                                     |
...
**최종 수정일시**: 2026-02-08 (통합 테스트 케이스 TC-001~TC-006 현황 추가)
